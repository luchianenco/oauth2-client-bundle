...
use KnpU\OAuth2ClientBundle\DependencyInjection\Providers\ImgurProviderConfigurator;
...
use KnpU\OAuth2ClientBundle\DependencyInjection\Providers\OptimizelyProviderConfigurator;
...
class KnpUOAuth2ClientExtension extends Extension
{
    ...
    private static $supportedProviderTypes = [
        ...
        'imgur' => ImgurProviderConfigurator::class,
        ...
        'optimizely' => OptimizelyProviderConfigurator::class,
